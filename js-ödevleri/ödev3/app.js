...
//Events
btnCon.addEventListener('click', filterItems);

//get buttons
function getUniqueCategories() {
    
    const uniqueCategories = menu.reduce((acc, currentItem) => {
...
function createMenuButtons() {
    ...
    const btnNames = getUniqueCategories(); 

    const buttonHtml = btnNames.map(btn => {
        return `<button class="btn-item btn btn-outline-dark" value="${btn}">${btn}</button>`
    })
    .join("");

    btnCon.innerHTML = buttonHtml;
